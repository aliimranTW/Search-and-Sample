...
def perception_step(Rover):
    ...
    wall_thresh = color_thresh_walls(warped)
    ...
    Rover.vision_image[:,:,2] = wall_thresh
    ...
    xpix_w, ypix_w = rover_coords(wall_thresh)
    ...
    x_world_w, y_world_w = pix_to_world(xpix_w, ypix_w, xpos, ypos, yaw, world_size, scale)
    # 7) Update Rover worldmap (to be displayed on right side of screen)
        # Example: Rover.worldmap[obstacle_y_world, obstacle_x_world, 0] += 1
    Rover.worldmap[y_world, x_world, 0] += 1
    Rover.worldmap[y_world_r,x_world_r,1] += 1
    Rover.worldmap[y_world_w,x_world_w,2] += 1
